 ...
 * {@code declLine} is {@code -1}; the {@code fqn}/{@code signature} are still resolved.
 *
 ...
 */
public record ResolvedRef(String fqn, String signature, Path declFile, int declLine) {}
